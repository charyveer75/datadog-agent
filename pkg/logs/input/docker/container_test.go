...
func TestFindSourceWithSourceFiltersShouldSucceed(t *testing.T) {
	...
	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "myapp"},
	...
	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "wrongapp"},
		Config:            &types_container.Config{Labels: map[string]string{"mylabel": "anything"}}},
		nil)
	source = container.FindSource(sources)
	assert.NotNil(t, source)
...
func TestIsImageMatch(t *testing.T) {
	...
	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "repository/myapp"},
		Config:            &types_container.Config{}},
		nil)
	assert.True(t, container.isImageMatch("myapp"))
	...
	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "myapp@sha256:1234567890"},
		Config:            &types_container.Config{}},
		nil)
	assert.True(t, container.isImageMatch("myapp"))

	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "repository/myapp@sha256:1234567890"},
		Config:            &types_container.Config{}},
		nil)
	assert.True(t, container.isImageMatch("myapp"))
	assert.True(t, container.isImageMatch("repository/myapp"))
	...
	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "repository/myapp:latest"},
		Config:            &types_container.Config{}},
		nil)
	assert.True(t, container.isImageMatch("myapp"))
	...
	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "myapp:latest"},
		Config:            &types_container.Config{}},
		nil)
	assert.True(t, container.isImageMatch("myapp"))
	assert.True(t, container.isImageMatch("myapp:latest"))
	...
	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "repositorymyapp"},
		Config:            &types_container.Config{}},
		nil)
	assert.False(t, container.isImageMatch("myapp"))

	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "myapp2"},
		Config:            &types_container.Config{}},
		nil)
	assert.False(t, container.isImageMatch("myapp"))

	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "myapp2@sha256:1234567890"},
		Config:            &types_container.Config{}},
		nil)
	assert.False(t, container.isImageMatch("myapp"))

	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "repository/myapp2"},
		Config:            &types_container.Config{}},
		nil)
	assert.False(t, container.isImageMatch("myapp"))

	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "repository/myapp2@sha256:1234567890"},
		Config:            &types_container.Config{}},
		nil)
	assert.False(t, container.isImageMatch("myapp"))

	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "repository/myapp2:latest"},
		Config:            &types_container.Config{}},
		nil)
	assert.False(t, container.isImageMatch("myapp"))

	container = NewContainer(types.ContainerJSON{
		ContainerJSONBase: &types.ContainerJSONBase{Image: "myapp2:latest"},
		Config:            &types_container.Config{}},
		nil)
	assert.False(t, container.isImageMatch("myapp"))
